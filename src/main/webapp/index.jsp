...
<body>
	...
	<div class="mainContainer">
		<form action="city" method="post" class="searchInput">
			<input type="text" placeholder="Enter City Name" id="searchInput"
				value="${city}" name="user_entered_city" />
			<button id="searchButton" onclick="city">
				<i class="fa-solid fa-magnifying-glass"></i>
			</button>
		</form>
		<div class="weatherDetails">
			<div class="weatherIcon">
				<img src="" alt="images/neutral.jpg" id="weather-icon">
				<h2>${temperature}°C</h2>
